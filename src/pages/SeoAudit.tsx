...
const howToSteps = [
  ...
  { title: "Review your score", description: "Get a score out of 100 with detailed categories showing errors, warnings, and passes." },
...
export default function SeoAudit() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <motion.p initial="hidden" animate="visible" variants={fadeUp} className="text-muted-foreground mb-6">Analyze your website and get AI-powered SEO recommendations.</motion.p>
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="glass-card p-6 flex items-center gap-6">
            <div className="relative h-20 w-20 shrink-0">
              <svg className="h-20 w-20 -rotate-90" viewBox="0 0 36 36">
                ...
                <circle cx="18" cy="18" r="16" fill="none" stroke="hsl(var(--primary))" strokeWidth="2" strokeDasharray={`${score * 1.005} 100`} strokeLinecap="round" />
              </svg>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {score >= 80 ? "Great job! Your site is well optimized." : score >= 50 ? "Room for improvement." : "Needs significant SEO work."}
              </p>
            </div>
          </motion.div>
